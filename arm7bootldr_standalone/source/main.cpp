...
void bootfile(){
	...
	if (fresult != FR_OK) {
		...
		pf_lseek(0, currentFH);
		int isNTRTWLBinary = isNTROrTWLBinaryTGDSMB7(currentFH, (u8*)&NDSHeaderStruct, sizeof(NDSHeaderStruct), ARM7i_HEADER_SCFG_EXT7, &isTGDSTWLHomebrew);
